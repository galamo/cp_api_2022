...
export default function Reports() {
    ...
    return (
        <div style={{ padding: "20px" }}>
            ...
            <button onClick={() => { setSize(500) }}>big</button>
            <ResponsiveContainer width="100%" height={size}>
                ...
                >
                    ...
                    {d && <Line type="monotone" dataKey="amt" stroke="#8884d8" activeDot={{ r: 8 }} />}
                </LineChart>
            </ResponsiveContainer>
    ...
    function Chart(props: any) {
        return <ResponsiveContainer width="100%" height={props.size}>
            ...
            >
                ...
                <Line type="monotone" dataKey="pv" stroke="#8884d8" activeDot={{ r: 8 }} />
                <Line type="monotone" dataKey="uv" stroke="#82ca9d" />
                {props.d && <Line type="monotone" dataKey="amt" stroke="#8884d8" activeDot={{ r: 8 }} />}
            </LineChart>
        </ResponsiveContainer>
    }
}
